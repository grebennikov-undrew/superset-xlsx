...
const MENU_KEYS = {
  ...
  EXPORT_PIVOTED_XLSX: 'export_pivoted_xlsx',
...
export interface SliceHeaderControlsProps {
  ...
  exportPivotedExcel?: (sliceId: number) => void;
  ...
  handleMenuClick({
    ...
    switch (key) {
      ...
      case MENU_KEYS.EXPORT_XLSX:
        ...
        break;
      case MENU_KEYS.EXPORT_PIVOTED_XLSX:
        // eslint-disable-next-line no-unused-expressions
        this.props.exportPivotedExcel?.(this.props.slice.slice_id);
        break;
        ...
        {this.props.slice.viz_type !== 'filter_box' &&
          this.props.supersetCanCSV && (
            <Menu.SubMenu title={t('Download')}>
              ...
              <Menu.Item
                key={MENU_KEYS.EXPORT_PIVOTED_XLSX}
                icon={<Icons.FileOutlined css={dropdownIconsStyles} />}
              >
                {t('Export pivoted to .XLSX')}
              </Menu.Item>
              <Menu.Item
