...
class Chart extends React.Component {
  constructor(props) {
    ...
    this.exportPivotedExcel = this.exportPivotedExcel.bind(this);
  ...
  exportPivotedExcel(isFullCSV = false) {
    this.props.logEvent(LOG_ACTIONS_EXPORT_CSV_DASHBOARD_CHART, {
      slice_id: this.props.slice.slice_id,
      is_cached: this.props.isCached,
    });
    ...
    return (
      ...
      >
        <SliceHeader
          ...
          exportPivotedExcel={this.exportPivotedExcel}
