...
export const exportChart = ({
  ...
  // console.log('# '+ new Date().toLocaleString() + ' superset-frontend/src/explore/exploreUtils/index.js -> exportChart. formData, that promotes to ' + url + " IS: " + safeStringify(payload))
