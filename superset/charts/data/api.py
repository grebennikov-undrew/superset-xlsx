...
class ChartDataRestApi(ChartRestApi):
    ...
    def get_data(self, pk: int) -> Response:
        ...
        try:
            ...
            return self.response_400(
                message=_(
                    "Request is incorrectly1: %(error)s", error=error.normalized_messages()
                )
            )
    ...
    def data(self) -> Response:
        ...
        try:
            ...
            return self.response_400(
                message=_(
                    "Request is incorrectly oops: %(error)s", error=error.normalized_messages()
                )
            )
    ...
    def data_from_cache(self, cache_key: str) -> Response:
        ...
        try:
            ...
            return self.response_400(
                message=_("Request is incorrectly3: %(error)s", error=error.messages)
            )
    ...
    def _create_query_context_from_form(
        ...
        try:
            ...
            raise ValidationError("Request is incorrectl4") from ex
        except ValidationError as error:
            raise error
